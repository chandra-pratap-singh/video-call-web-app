  ...
  >
    ...
    <div class="background-gray d-flex flex-centered p-l bottom-bar">
      <div class="d-flex flex-justify-content-space-between w-50 m-w-100">
        ...
        />
        <${f} icon=${p} onclick=${()=>{n.endCall(),location.assign("/")}} />
      </div>
    </div>
  </div>`}}}]);